...
(function (root, factory) {
  ...
  function open(opts) {
    ...
    var avatars = Array.isArray(opts.avatars) ? opts.avatars : (Array.isArray(window.__avatars) ? window.__avatars : []);

    return new Promise(function (resolve) {
      // we will render directly into the panel already in index.html if present
      var panel = document.getElementById('avatarPickerPanel');
      if (!panel) {
        // fallback to body overlay
      ...
      if (!document.getElementById('avatarPickerPanel')) {
